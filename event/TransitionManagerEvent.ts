 ...
 * (containers of containers of etc.) of the {{#crossLink "DisplayObjectContainer"}}{{/crossLink}}that originally dispatched the Event, all the way up to the surface
 * ({{#crossLink "Stage"}}{{/crossLink}}). Any classes that do not have a parent cannot bubble.
