...
class TransitionManager extends EventDispatcher {
    ...
    //protected _transitionFactory:TransitionFactory = TransitionFactory;
    ...
    public registerTransition(key:string):any {
        //this._transitionFactory.registerTransition(key);
